...
class CVService {
    ...
    static getCV(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const cv = yield prisma_1.default.cV.findUnique({
                where: { id }
            });
            if (!cv) {
    ...
    static generateCV(id, cvData, jobData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
...
Renvoie uniquement le JSON du CV optimisé, sans texte supplémentaire.`;
                ...
                yield prisma_1.default.cV.update({
                    where: { id },
                    data: {
                        optimizedCV,
                        status: 'completed'
                ...
                yield prisma_1.default.cV.update({
                    ...
                    data: {
                        status: 'error',
                        error: (error === null || error === void 0 ? void 0 : error.message) || 'Erreur inconnue lors de la génération'
                    }
                });
            }
        });
